                    ...
                    <th scope="col" >
                        <h3>Sign Into your TaskThru Page</h3>
                                        ...
                                        <asp:Panel ID="LoginPanel" runat="server" Visible="true" >
                                                ...
                                                <table class="table">
                                                        <tr> <asp:Label ID="Label1" runat="server" Text=""  CssClass="warningstyle"></asp:Label></tr>
                                                          <tr>
                                                            <th scope="col"><span>Username</span></th>
                                                            <th scope="col"><asp:TextBox ID="UserIDText" runat="server" Width="50%"></asp:TextBox></th>
                                                          </tr>

                                                          <tr>
                                                            <th scope="col"><span>Password</span></th>
                                                            <th scope="col"><asp:TextBox TextMode="Password" runat="server" Id="txtPassword"  class="labelText" width="50%" ></asp:TextBox></th>
                                                         </tr>

                                                         <tr>
                                                                <th scope="col"></th>
                                                                <th scope="col"><input id="Login1_RememberMe"  style="width:10%" type="checkbox" name="Login1$RememberMe" /><label for="Login1_RememberMe">Remember me </label></th>
                                                             </tr>
                                                    <tr>
                                                        <th scope="col">
                                                        ...
                                                        <th scope="col">
                                                             <asp:Button ID="btnLogin" CssClass="loginbutton" width="50%" style="margin-top:20px; "  runat="server" Text="Log In" onclick="FnCheckLogin"/>
                                                        </th>
                                                    </tr>
                                        ...
                                        <asp:Panel ID="SelectDepartmentPan" runat="server" Visible="false" >
                                                ...
                                                <table class="table">
                                                    <tr>
                                                    <th scope="col"><h5>Select department that you are signing into today.</h5></th>
                                                        </tr>
                                                    <tr>
                                                        <th scope="col">                                                        
                                                    ...
                                                    <tr>
                                                        <th scope="col">                                           
                                                               <asp:Button ID="proceedBtn" CssClass="loginbutton" runat="server"  Text="Proceed" Width="50%" OnClick="Button1_Click" />
                                                       
                                                    </th>  
                                                        </tr>
                                                    <tr>
                                                        <th scope="col">
                                                             <asp:Button ID="Button2" CssClass="loginbutton" Text="Back" runat="server" style="margin-top:30px; float:left;" Width="20%" OnClick="Button2_Click" />   
                                                        </th>
                                                    </tr>
                                                      </table>
