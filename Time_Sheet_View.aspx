...
visibility: hidden;
        ...
        .style1
        {
         ...
         .standoutstyle
        {
            color: orangered;font-family: Arial;font-weight: bolder;font-style:italic;font-size:x-small;
        }
...
<asp:Content runat="server" id="MainContentId" style="height:100%" ContentPlaceHolderID="MainContent"  >   
     ...
     <div style="padding:0px;">
            ...
            <div id="mysidenavOpt" class="sidenav" style="margin-top:114px; background-color:rgb(146, 146, 146); padding-right:5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> 
                    ...
                    <div class="jumbotron" style="padding:0px; margin-left:5px; background-color:transparent; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> 
                            ...
                            <div class="dropdown"><asp:DropDownList runat="server" DataTextField="Project_Name" DataValueField="ProjectId" CssClass="btn btn-default btn-sm" id="ProjectDD" AppendDataBoundItems="true" name="ProjectDD" OnSelectedIndexChanged="ProjectDD_SelectedIndexChanged" AutoPostBack="true"><asp:ListItem Value="" Text="---Order Id---"></asp:ListItem></asp:DropDownList></div> 
                            <div class="dropdown"><asp:DropDownList runat="server" ID="Staff_Name"  Name= "Staff_Name" DataTextField="Staff_Name"  DataValueField="Staff_Id" CssClass="btn btn-default btn-sm"  AppendDataBoundItems="true" >
                                                                        <asp:ListItem Text="--- Staff Name---" Value=""></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </div>
                                                                <span><input type="button" value="Apply" runat="server" class="btn btn-default btn-xs" style="background-color: white; "  onClick="if(FnValidation(event))" onServerClick="Load_Data" /></span>
                            
                            <div style="margin-top:10px;"><asp:Button ID="Button3" CssClass="btn btn-default btn-sm" Text="Show all Users" runat="server" OnClick="Button3_Click" /></div>
                            <div><asp:Button ID="Button5" CssClass="btn btn-default btn-sm" Text="Your Records" runat="server" OnClick="Button5_Click"  /></div>
                    
                            <div style="margin-top:10px;"><asp:Button ID="Button2" CssClass="btn btn-default btn-sm" Text="Previous Day" OnClick="Button2_Click"  runat="server"   /></div>
                            <div><asp:Button ID="Button1" CssClass="btn btn-default btn-sm" Text="Following Day" runat="server" OnClick="Button1_Click"   /></div>
                            <div><asp:Button ID="Button4" CssClass="btn btn-default btn-sm" Text="Today" OnClick="Button4_Click"  runat="server"   /></div>
                            
                            
                            <div class="label"><asp:TextBox runat="server" CssClass="form-control"  id="DateFrom" name="DateFrom" TextMode="SingleLine" ></asp:TextBox></div>
                            <div class="label"><asp:TextBox runat="server" CssClass="form-control"   id="DateTo" name="DateTo" TextMode="SingleLine" ></asp:TextBox></div> 
                            <div><span><input type="button" value="Apply" runat="server" Id="Load_Button"   class="btn btn-default btn-xs" style="background-color: white; "  onClick="if(FnValidation(event))" onServerClick="Load_Data" /></span></div>
    ...
    <span class="glyphicon glyphicon-hand-right" style="margin:4px; margin-top:-18px; float:right;"></span><asp:Button ID="GoToMiniBtn" runat="server" CssClass="btn btn btn-danger btn-xs" style="float:right; margin-top:-27px; font-size:small; color:rgb(245, 245, 245); color:white; background-color:rgb(146, 146, 146);" Text="Customer Service" OnClick="GoToMiniBtn_Click" />
    ...
    <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12 col-md-offset-3 col-lg-offset-3" > 
                ...
                <div style="margin:0px; margin-top:18px; padding:0px;"> 
                    ...
                    </div><center><span id="SyncBadge" style="margin-top:0px; margin-bottom:20px; border-radius:5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" class="badge badge-secondary">Sync in progress..</span></center>
            ...
            <div style="display:none;margin-bottom:20px; margin-left:-5px; margin-right:-10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); padding:15px; border-radius:15px; background-color:#dfdfdf; ">        
                    <asp:Panel ID="ActiveOrdersNameSearch" runat="server" DefaultButton="Button6" style="text-align:center; margin-top:5px; margin-bottom:5px; "><center style="display:inline; text-align:center;" visible="true" runat="server" id="SearchCustomerDiv" >
      ...
      <%--  <div style="margin-bottom:20px; margin-left:-5px; margin-right:-10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); padding:15px; border-radius:15px; background-color:#dfdfdf; ">
            <center><asp:Button ID="AttendanceInBtn" runat="server" CssClass="btn-sm" OnClick="AttendanceInBtn_Click" /><br />
             ...
             <center><div style="width:auto;display:none; margin-bottom:20px; margin-left:-5px; margin-right:-10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); padding:0px; border-radius:15px; background-color:#dfdfdf; ">        
...
<center><div style="margin-bottom:0px; background-color:#efefef; padding-top:5px; padding-bottom:5px;">
        <div visible="false" runat="server" id="UnAssignedDiv" >
                <span style="background-color:#ece5f0; color:black; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" Font-Size="medium" class="badge badge-secondary"><asp:Label ID="UnAssigneCount"  runat="server" ForeColor="#0e0e0e"  Font-Size="medium"></asp:Label> Unassigned Orders</span><span class="glyphicon glyphicon-arrow-right"></span><asp:HiddenField ID="HiddenField7" runat="server" Value="0"/><asp:Button ID="UnAssignedBtn" runat="server" CssClass="btn btn btn-danger btn-sm" OnClick="DistributeOrders_Click" style="border-radius:7px; border-top-left-radius: 7px; border-bottom-left-radius: 7px; font-size:small; background-color:#dac7e4;" Text="Auto Assign Now" />
                         </div>
     <div visible="false" runat="server" id="UnAssignedProcessDiv" >
                <span style="background-color:#ece5f0; color:black; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" Font-Size="medium" class="badge badge-secondary"><asp:Label ID="UnAssignedProcessCount"  runat="server" ForeColor="#0e0e0e"  Font-Size="medium"></asp:Label> Unassigned - Staff Offline</span><span class="glyphicon glyphicon-arrow-right"></span><asp:HiddenField ID="HiddenField9" runat="server" Value="0"/><asp:Button ID="Button7" runat="server" CssClass="btn btn btn-danger btn-sm" OnClick="DistributeAllProcessOrders_Click" style="border-radius:7px; border-top-left-radius: 7px; border-bottom-left-radius: 7px; font-size:small; background-color:#dac7e4;" Text="Auto Assign Now" /><br /><asp:Label ID="StaffStatus"  runat="server" ForeColor="#0e0e0e"  Font-Size="medium" Visible="false"></asp:Label>
                         </div>
    <div visible="false" runat="server" id="UnassignedDeliveriesDiv" >  <asp:Button ID="UnAssignedDeliveriesBtn" runat="server" CssClass="btn btn btn-danger btn-sm" OnClick="UnAssignedDeliveries_Click" style="border-radius:7px; border-top-left-radius: 7px; border-bottom-left-radius: 7px; font-size:small; background-color:#e7cfaa;" Text="Unassigned Deliveries" /><span style="background-color:#e7cfaa" class="badge badge-secondary"><asp:Label ID="UnAssignedDeliveryCount" runat="server" Font-Bold="true" ForeColor="#0e0e0e" Font-Size="small"></asp:Label></span></div> <div visible="false" runat="server" id="AcceptAllUnpickedDiv" ><asp:Button ID="AcceptAllUnpickedBtn" runat="server" CssClass="btn btn btn-danger btn-sm" OnClick="AcceptAllUnpickedOrdersBtn_Click" style="border-radius:7px; border-top-left-radius: 7px; border-bottom-left-radius: 7px; font-size:small; background-color:#d3b4f5; margin-top:10px; margin-bottom:10px;" Text="Accept All Un-Picked Orders" /><asp:Label ID="Label10"  runat="server" ForeColor="#0e0e0e"  Font-Size="medium"></asp:Label> </div>
                                                                                </div></center><asp:HiddenField ID="UnAssignedDvryHdn" runat="server" Value="0" /><asp:HiddenField ID="ExceptionDriverHdn" runat="server" Value="0" />
            <div style="text-align:center;" class="container"><span class="label" style="color:rgb(95, 146, 117);font-size:small">Enter Real time activities.</span><asp:TextBox ID="InputTxt" runat="server" CssClass="form-control" placeholder="Enter Activity"></asp:TextBox>
          <center><table style="text-align:center;padding:10px;" align="center">
...
<asp:Button ID="bt2" runat="server" CssClass="btn-sm btn-default" Text="Travelling" OnClick="bt2_Click" style="display:inline;" /></td></tr>
              <td><asp:Button ID="bt3" runat="server" CssClass="btn-sm btn-default" Text="Expecting Visitor" OnClick="bt3_Click" style="display:inline;" /></td><td>--%>
                  <tr><td><asp:Button ID="Button8" runat="server" CssClass="btn-sm btn-default" Text="Set an Activity" OnClick="Button8_Click" style="display:inline;" /></td></tr>
          </table></center></div><br />
         <center><asp:Label ID="displayHeadingLab" runat="server" class="label" style="color:rgb(95, 146, 117);font-size:small"></asp:Label></center>
                ...
                <div class="modal-dialog" role="document"> 
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <asp:Button OnClick="ModalCloseClick" runat="server" CssClass="btn btn-secondary btn-xs" style="float:right; font-size:large; background-color:white; color:black; border-radius:5px;" Text=&times; /></div>
                    <div class="modal-body modal-body-touch">
                            <iframe id = "orderIframe" frameborder="0" height="85%" width="99.6%"></iframe> 
                             
                    </div><div class="modal-footer"><asp:Button Mvalue="0" ID="ModalCloseBtn" OnClick="ModalCloseClick" runat="server" CssClass="btn btn-secondary" style="background-color:white; color:black; border-radius:5px;" Text="Close" /></div></div></div></div>
 ...
 <!-- **********************************************************************************************NEW MODAL SYSTEM FOR ORDERS -->
        ...
        <div class="task widget-primary" style="width:30%;height:340px; visibility:hidden;">
            <div class="widget-body">
                <div class="text-muted" >Activity chart </div><br />
                <div style="width:100%;height:300px;" id="chart_div"></div>
            </div>
            <div><asp:Label ID="lbActivityChart" runat="server" CssClass="text-muted"></asp:Label></div>
        </div>
        ...
        <div class="task widget-info">
         ...
         <div class="task widget-info" style="width:32%;height:340px; visibility:hidden;" >
            <div class="widget-body">
                <div class="text-muted" >Status Nature - Denoted by Border Style. Sorted by priority (descending manner). </div><br />
       ...
       <div class="overview" style="width:100%; max-width:100%; min-width:100%; text-align:center;"   >
           <asp:HiddenField ID="PickUpHdn" runat="server" Value="0" /><asp:DropDownList runat="server" CssClass="dropdown-toggle.btn-default" Visible="false"  style="width:100px;"   DataTextField="Company_Unit_Name"  DataValueField="Unit_Id"   id="Company_Unit_Name" AppendDataBoundItems="true" name="Company_Unit_Name">
                                                <asp:ListItem Value="" Text="---Company Unit Name---"></asp:ListItem></asp:DropDownList>
